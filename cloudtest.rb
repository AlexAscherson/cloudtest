...
$input1 = gets.upcase.chomp.chars
puts "enter search string"
$input2 = gets.upcase.chomp.chars

$stringsearchingfor = 0
$matcharray = []
$result = ""

def checkformorematches
   
  $input1.each_with_index do | val, i |
    puts "checking "+ val
    # Is the first letter found?
    if $input2[$stringsearchingfor] == val
      # First letter found
      ...
      if $input2.length == $stringsearchingfor
